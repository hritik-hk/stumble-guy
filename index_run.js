...
function handleStart(e){
    ...
    else document.removeEventListener("keydown", handleStart);
...
function isCollision(guy,spike){
    return (
        spike.left+40<guy.right &&
        spike.top+40<guy.bottom &&
        guy.left +40< spike.right  &&
...
function handleLose(){
    ...
    setTimeout(()=>{
        ...
        document.addEventListener("keydown",handleStart);
        startScreenElem.textContent=`Press Space To Restart!`;
    },2000);
